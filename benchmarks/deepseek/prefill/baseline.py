...
def _benchmark_vllm(args):
    ...
    def run(batched_tokens):
        ...
        llm.n_step = 0
        prompts = [TokensPrompt(prompt_token_ids=[100] * batched_tokens)] * 3
...
if __name__ == "__main__":
    ...
    args.max_num_seqs = 1
    args.max_num_batched_tokens = 81920
    args.max_tokens = 21101
    args.async_scheduling = True
    args.batched_tokens_list = [1, 2, 4, 8, 16, 32, 64, 128, 256, 512] + list(range(1024, 81921, 1024))
