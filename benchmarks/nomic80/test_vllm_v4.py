...
class VllmEncoder(MtebEmbedMixin):

    def __init__(self, model_name:str, revision:str, dtype, trust_remote_code: bool = True, **kwargs):
    ...
    def encode(
        ...
        **kwargs,
        ...
        sentences = [text * 80 for batch in inputs for text in batch["text"]]
...
if __name__ == "__main__":
    ...
    encoder = VllmEncoder(model_name=model_name, revision=revision, dtype="float32")
